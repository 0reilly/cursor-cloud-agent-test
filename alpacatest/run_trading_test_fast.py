#!/usr/bin/env python3
"""
Run trading engine with HMM regime-aware strategy for testing (fast version).
"""
import sys
import time
import logging
...
def main():
    print("Starting HMM Regime-Aware Trading Engine Test (Fast)")
    print("=" * 60)
    
    # Import here to avoid circular imports
    from trading_engine import TradingEngine
    
    # Create engine with shorter interval
    engine = TradingEngine(scan_interval_minutes=2)
    ...
    # Run for N scans
    num_scans = 5  # Run 5 scans (~10 minutes)
    print(f"\nRunning {num_scans} market scans (2-minute intervals)...")
