...
exports.products = [
    {
        ...
        darkPatterns: [
            {
                pattern: mockDarkPatterns_1.default.find(dp => dp.id === 'dp5'),
    ...
    },
    {
        ...
        darkPatterns: [
            ...
            {
                pattern: mockDarkPatterns_1.default.find(dp => dp.id === 'dp3'),
                prevalence: 'ubiquitous',
    ...
    },
    {
        ...
        darkPatterns: [
            {
                pattern: mockDarkPatterns_1.default.find(dp => dp.id === 'dp1'),
                prevalence: 'common',
