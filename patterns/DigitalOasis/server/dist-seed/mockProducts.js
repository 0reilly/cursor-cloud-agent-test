...
const combinedStudies_1 = __importDefault(require("./combinedStudies"));
// Helper to find studies by affected products
const getStudiesForProduct = (productName) => {
    return combinedStudies_1.default.filter(study => study.productsAffected.some(p => p.toLowerCase().includes(productName.toLowerCase()) ||
