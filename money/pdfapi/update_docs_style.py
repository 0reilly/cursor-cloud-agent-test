...
with open('public/docs.html', 'r') as f:
    html = f.read()

# Add Google Fonts link before style if not present
if 'fonts.googleapis.com' not in html:
    # Insert after <head> and before <style>
    html = html.replace('<head>', '<head>\n    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">')

# New CSS (same as index.html)
new_style = '''    <style>
        :root {
            --primary: #667eea;
            --primary-dark: #764ba2;
...
with open('public/docs.html', 'w') as f:
    f.write(html)

print('Updated docs.html with new design')